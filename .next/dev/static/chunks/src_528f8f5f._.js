...
class ErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"] {
    ...
    logErrorToService(error, errorInfo) {
        // Implement external error logging
        fetch('/api/errors', {
            method: 'POST',
            headers: {
...
function useNotifications() {
    ...
    const addToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[addToast]": (toast)=>{
            const id = Math.random().toString(36).substring(2, 9);
            setToasts({
                "useNotifications.useCallback[addToast]": (prev)=>[
                        ...prev,
                        {
                            ...toast,
                            id
            ...
            }["useNotifications.useCallback[addToast]"]);
        }
    }["useNotifications.useCallback[addToast]"], []);
    const removeToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[removeToast]": (id)=>{
            setToasts({
                "useNotifications.useCallback[removeToast]": (prev)=>prev.filter({
                        "useNotifications.useCallback[removeToast]": (toast)=>toast.id !== id
                    }["useNotifications.useCallback[removeToast]"])
            }["useNotifications.useCallback[removeToast]"]);
        }
    }["useNotifications.useCallback[removeToast]"], []);
    const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[success]": (title, message)=>{
            addToast({
                type: 'success',
                title,
                message
    ...
    }["useNotifications.useCallback[success]"], [
        addToast
    ]);
    const error = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[error]": (title, message)=>{
            addToast({
                type: 'error',
                title,
                message,
    ...
    }["useNotifications.useCallback[error]"], [
        addToast
    ]);
    const warning = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[warning]": (title, message)=>{
            addToast({
                type: 'warning',
                title,
                message
    ...
    }["useNotifications.useCallback[warning]"], [
        addToast
    ]);
    const info = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[info]": (title, message)=>{
            addToast({
                type: 'info',
                title,
                message
    ...
    }["useNotifications.useCallback[info]"], [
        addToast
    ]);
    return {
        toasts,
...
_s(useNotifications, "eBP+PTp7SSMazoJp7ONASJJkw08=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/NotificationToast.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const NotificationToast = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(_c = _s(function NotificationToast({ toast, onDismiss }) {
    _s();
    const [isVisible, setIsVisible] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationToast.NotificationToast.useEffect": ()=>{
            setIsVisible(true);
            const timer = setTimeout({
                "NotificationToast.NotificationToast.useEffect.timer": ()=>{
                    setIsVisible(false);
                    setTimeout({
                        "NotificationToast.NotificationToast.useEffect.timer": ()=>onDismiss(toast.id)
                    }["NotificationToast.NotificationToast.useEffect.timer"], 300);
                }
            }["NotificationToast.NotificationToast.useEffect.timer"], toast.duration || 5000);
            return ({
                "NotificationToast.NotificationToast.useEffect": ()=>clearTimeout(timer)
            })["NotificationToast.NotificationToast.useEffect"];
        }
    }["NotificationToast.NotificationToast.useEffect"], [
        toast.id,
    ...
    const iconMap = {
        success: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$CheckCircleIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircleIcon$3e$__["CheckCircleIcon"],
        error: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$ExclamationTriangleIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ExclamationTriangleIcon$3e$__["ExclamationTriangleIcon"],
        warning: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$ExclamationTriangleIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ExclamationTriangleIcon$3e$__["ExclamationTriangleIcon"],
        info: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroicons$2f$react$2f$24$2f$outline$2f$esm$2f$InformationCircleIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__InformationCircleIcon$3e$__["InformationCircleIcon"]
    };
    const colorMap = {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Icon, {
                            ...
                            fileName: "[project]/src/components/NotificationToast.tsx",
                            lineNumber: 64,
                            columnNumber: 13
                        }, this)
                    }, void 0, false, {
...
}, "J3yJOyGdBT4L7hs1p1XQYVGMdrY=")), "J3yJOyGdBT4L7hs1p1XQYVGMdrY=");
_c1 = NotificationToast;
var _c, _c1;
__turbopack_context__.k.register(_c, "NotificationToast$memo");
__turbopack_context__.k.register(_c1, "NotificationToast");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/NotificationProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NotificationToast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/NotificationToast.tsx [app-client] (ecmascript)");
;
...
function NotificationProvider({ children }) {
    _s();
    const notifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: notifications.toasts.map((toast)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NotificationToast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationToast"], {
                            toast: toast,
                            onDismiss: notifications.removeToast
                        }, toast.id, false, {
                            fileName: "[project]/src/components/NotificationProvider.tsx",
                            lineNumber: 23,
                            columnNumber: 13
                        }, this))
                }, void 0, false, {
...
_s(NotificationProvider, "sMJ90/kRxUkd0CXXcFpyH/UuKFg=", false, function() {
    return [
...
_s1(useNotificationContext, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
...
"[project]/src/types/enhancedCart.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/utils/generateId.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/stores/enhancedCartStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$enhancedCart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/types/enhancedCart.ts [app-client] (ecmascript)");
...
const useEnhancedCartStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        addItem: (product, options = {})=>{
            set((state)=>{
                const existingItemIndex = state.items.findIndex((item)=>item.product.id === product.id && item.selectedDate?.getTime() === options.selectedDate?.getTime() && JSON.stringify(item.selectedTimeSlot) === JSON.stringify(options.selectedTimeSlot));
        ...
        updateStudent: (itemId, studentId, studentUpdate)=>{
            set((state)=>({
                    items: state.items.map((item)=>item.id === itemId ? {
                            ...item,
                            students: item.students.map((student)=>student.id === studentId ? {
                                    ...student,
                                    ...studentUpdate
                                } : student)
                        } : item)
            ...
            set((state)=>({
                    items: state.items.map((item)=>item.id === itemId ? {
                            ...
                            students: [
                                ...
                                {
                                    ...student,
                                    id: student.id || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$generateId$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateId"])()
                                }
                            ]
                        } : item)
                }));
        },
        removeStudent: (itemId, studentId)=>{
            set((state)=>({
                    items: state.items.map((item)=>item.id === itemId ? {
                            ...item,
                    ...
                    items: state.items.map((item)=>{
                        if (item.id === itemId) {
                            ...
                            if (details.quantity !== undefined || details.selectedAddOns !== undefined) {
                                updatedItem.totalPrice = calculateItemPrice(updatedItem.product, updatedItem.quantity, updatedItem.selectedAddOns);
                            }
                            return updatedItem;
                        }
                        return item;
        ...
        clearCartAfterSuccess: async (orderId)=>{
            try {
        ...
        getSummary: ()=>{
            ...
            const tax = subtotal * __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$enhancedCart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GST_RATE"];
        ...
        getValidation: ()=>{
            ...
            items.forEach((item)=>{
                ...
                if (item.quantity > item.students.length && (item.product.category === 'camps' || item.product.category === 'birthdays')) {
                    errors.push({
                        itemId: item.id,
                        field: 'students',
                ...
                items.forEach((otherItem)=>{
                    if (otherItem.id !== item.id && item.selectedDate && otherItem.selectedDate && item.selectedDate.getTime() === otherItem.selectedDate.getTime() && item.selectedTimeSlot && otherItem.selectedTimeSlot && JSON.stringify(item.selectedTimeSlot) === JSON.stringify(otherItem.selectedTimeSlot)) {
                        // Check if same student is in both items
                        const studentOverlap = item.students.some((student)=>otherItem.students.some((otherStudent)=>student.firstName === otherStudent.firstName && student.lastName === otherStudent.lastName));
                        if (studentOverlap) {
                            warnings.push({
                                itemId: item.id,
...
_s(Header, "VRDhy70INxNK4ecucDldFzK0buA=", false, function() {
    return [
...
//# sourceMappingURL=src_528f8f5f._.js.map