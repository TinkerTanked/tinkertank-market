        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex space-x-4'>
              ...
              <a href='https://www.instagram.com/_tinkertank_' target='_blank' rel='noopener noreferrer' className='text-gray-400 hover:text-white transition-colors duration-200'>
              ...
              <a href='https://www.linkedin.com/company/tinker-tank' target='_blank' rel='noopener noreferrer' className='text-gray-400 hover:text-white transition-colors duration-200'>
